...
export interface ConjugationTable {
  ...
  irregular?: boolean;
  irregularNote?: string;       // Short learner-facing note shown in the conjugation modal
}
...
export const CONJUGATIONS: Record<string, ConjugationTable> = {
  ...
  devolver: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo devuelvo, él devuelve, ustedes devuelven. Vos stays regular.',
  },
  planchar: {
  ...
  fregar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo friego, él friega, ustedes friegan. Vos stays regular.',
  },
  cargar: {
  ...
  despertar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo despierto, él despierta, ustedes despiertan. Vos stays regular.',
  },
  ...
  cerrar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo cierro, él cierra, ustedes cierran. Vos stays regular.',
  },
  pensar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo pienso, él piensa, ustedes piensan. Vos stays regular.',
  },
  entender: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo entiendo, él entiende, ustedes entienden. Vos stays regular.',
  },
  empezar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo empiezo, él empieza, ustedes empiezan. Past yo is empecé.',
  },
  perder: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo pierdo, él pierde, ustedes pierden. Vos stays regular.',
  },
  querer: {
    ...
    irregular: true,
    irregularNote: 'Present uses quiero/quiere/quieren. Past uses quis-. Future uses querr-.',
  },
  ...
  dormir: {
    ...
    irregular: true,
    irregularNote: 'Present uses duermo/duerme/duermen. Past él/ustedes are durmió/durmieron.',
  },
  volver: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo vuelvo, él vuelve, ustedes vuelven. Vos stays regular.',
  },
  poder: {
    ...
    irregular: true,
    irregularNote: 'Present uses puedo/puede/pueden. Past uses pud-. Future uses podr-.',
  },
  jugar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo juego, él juega, ustedes juegan. Past yo is jugué.',
  },
  recordar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo recuerdo, él recuerda, ustedes recuerdan. Vos stays regular.',
  },
  encontrar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo encuentro, él encuentra, ustedes encuentran. Vos stays regular.',
  },
  costar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo cuesto, él cuesta, ustedes cuestan. Vos stays regular.',
  },
  almorzar: {
    ...
    irregular: true,
    irregularNote: 'Present uses almuerzo/almuerza/almuerzan. Past yo is almorcé.',
  },
  ...
  sentir: {
    ...
    irregular: true,
    irregularNote: 'Present uses siento/siente/sienten. Past él/ustedes are sintió/sintieron.',
  },
  pedir: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo pido, él pide, ustedes piden. Past él/ustedes are pidió/pidieron.',
  },
  repetir: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo repito, él repite, ustedes repiten. Past él/ustedes are repitió/repitieron.',
  },
  servir: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo sirvo, él sirve, ustedes sirven. Past él/ustedes are sirvió/sirvieron.',
  },
  vestirse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me visto, él se viste, ustedes se visten. Past uses vistió/vistieron.',
  },
  despedirse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me despido, él se despide, ustedes se despiden. Past uses despidió/despidieron.',
  },
  ...
  ser: {
    ...
    irregular: true,
    irregularNote: 'This verb changes a lot. Use the table instead of guessing from a pattern.',
  },
  ir: {
    ...
    irregular: true,
    irregularNote: 'This verb changes a lot. Its past forms match ser: fui, fuiste, fue, fuimos, fueron.',
  },
  tener: {
    ...
    irregular: true,
    irregularNote: 'For tener: yo is tengo. Él/ustedes are tiene/tienen. Past uses tuv-. Future uses tendr-.',
  },
  hacer: {
    ...
    irregular: true,
    irregularNote: 'Yo is hago. Past él is hizo. Future uses har-.',
  },
  decir: {
    ...
    irregular: true,
    irregularNote: 'Yo is digo. Él/ustedes are dice/dicen. Past uses dij-. Future uses dir-.',
  },
  saber: {
    ...
    irregular: true,
    irregularNote: 'Yo is sé. Past uses sup-. Future uses sabr-.',
  },
  ver: {
    ...
    irregular: true,
    irregularNote: 'Yo is veo. Past is short: vi, viste, vio, vimos, vieron.',
  },
  dar: {
    ...
    irregular: true,
    irregularNote: 'Yo is doy. Past is short: di, diste, dio, dimos, dieron.',
  },
  poner: {
    ...
    irregular: true,
    irregularNote: 'Yo is pongo. Past uses pus-. Future uses pondr-.',
  },
  traer: {
    ...
    irregular: true,
    irregularNote: 'Yo is traigo. Past uses traj-.',
  },
  salir: {
    ...
    irregular: true,
    irregularNote: 'Yo is salgo. Future uses saldr-.',
  },
  venir: {
    ...
    irregular: true,
    irregularNote: 'Yo is vengo. Él/ustedes are viene/vienen. Past uses vin-. Future uses vendr-.',
  },
  conocer: {
  ...
  leer: {
    ...
    irregular: true,
    irregularNote: 'Past él/ustedes add y: leyó/leyeron.',
  },
  oír: {
    ...
    irregular: true,
    irregularNote: 'Yo is oigo. Present and past él/ustedes use y: oye/oyen and oyó/oyeron.',
  },
  construir: {
    ...
    irregular: true,
    irregularNote: 'Past él/ustedes add y: construyó/construyeron.',
  },
  huir: {
    ...
    irregular: true,
    irregularNote: 'Present and past él/ustedes use y: huye/huyen and huyó/huyeron.',
  },
  influir: {
    ...
    irregular: true,
    irregularNote: 'Present and past él/ustedes use y: influye/influyen and influyó/influyeron.',
  },
  ...
  sentarse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me siento, él se sienta, ustedes se sientan. Vos stays regular.',
  },
  ducharse: {
  ...
  acostarse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me acuesto, él se acuesta, ustedes se acuestan. Vos stays regular.',
  },
  despertarse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me despierto, él se despierta, ustedes se despiertan. Vos stays regular.',
  },
  cepillarse: {
  ...
  acordarse: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo me acuerdo, él se acuerda, ustedes se acuerdan. Vos stays regular.',
  },
  quejarse: {
  ...
  arrepentirse: {
    ...
    irregular: true,
    irregularNote: 'Present uses me arrepiento/se arrepiente/se arrepienten. Past uses arrepintió/arrepintieron.',
  },
  irse: {
    ...
    irregular: true,
    irregularNote: 'This verb changes a lot. Its past forms match ir and ser: me fui, te fuiste, se fue.',
  },
  ponerse: {
    ...
    irregular: true,
    irregularNote: 'Yo is me pongo. Past uses pus-. Future uses pondr-.',
  },
  quedarse: {
  ...
  gustar: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me gusta, te gusta, les gusta.',
  },
  encantar: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me encanta, te encanta, les encanta.',
  },
  importar: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me importa, te importa, les importa.',
  },
  doler: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les. Present uses duele: me duele, te duele, les duele.',
  },
  faltar: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me falta, te falta, les falta.',
  },
  parecer: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me parece, te parece, les parece.',
  },
  quedar: {
    ...
    irregular: true,
    irregularNote: 'Use me/te/le/nos/les with this verb: me queda, te queda, les queda.',
  },
  tocar: {
  ...
  sonreír: {
    ...
    irregular: true,
    irregularNote: 'Keep the í sound in present: sonrío, sonríe, sonríen. Past él/ustedes are sonrió/sonrieron.',
  },
  vacilar: {
  ...
  pasarla: {
    ...
    irregular: true,
    irregularNote: 'Keep la with the verb: la paso, la pasé, la pasaré.',
  },
  montar: {
  ...
  hacerse: {
    ...
    irregular: true,
    irregularNote: 'Yo is me hago. Past él is se hizo. Future uses har-.',
  },
  pegar: {
  ...
  pelar_bolo: {
    ...
    irregular: true,
    irregularNote: 'Keep bolo in the phrase: pelo bolo, pelé bolo, pelaré bolo.',
  },
  estar: {
  ...
  despedir: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo despido, él despide, ustedes despiden. Past él/ustedes are despidió/despidieron.',
  },
  renunciar: {
  ...
  hacer_mandado: {
    ...
    irregular: true,
    irregularNote: 'Yo is hago mandado. Past él is hizo mandado. Future uses har-.',
  },
  hacerse_el_cojo: {
    ...
    irregular: true,
    irregularNote: 'Yo is me hago el cojo. Past él is se hizo el cojo. Future uses har-.',
  },
  tirar_la_stone: {
    ...
    irregular: true,
    irregularNote: 'Keep la stone in the phrase: tiro la stone, tiré la stone, tiraré la stone.',
  },
  esconder_la_mano: {
    ...
    irregular: true,
    irregularNote: 'Keep la mano in the phrase: escondo la mano, escondí la mano, esconderé la mano.',
  },
  quedar_en_tablas: {
    ...
    irregular: true,
    irregularNote: 'Keep en tablas in the phrase: quedo en tablas, quedé en tablas, quedaré en tablas.',
  },
  meterse_en_camisa_de_once_varas: {
    ...
    irregular: true,
    irregularNote: 'Keep the full phrase together with me/te/se: me meto, me metí, me meteré.',
  },
  estar_en_la_mierda: {
    ...
    irregular: true,
    irregularNote: 'This phrase follows estar: estoy, estuve, estaré.',
  },
  saber_la_puntica: {
    ...
    irregular: true,
    irregularNote: 'This phrase follows saber: sé, supe, sabré.',
  },
  echarse_una_cabeza: {
    ...
    irregular: true,
    irregularNote: 'Keep the full phrase together with me/te/se: me echo, me eché, me echaré.',
  },
  echarse_un_polvo: {
  ...
  dar_papaya: {
    ...
    irregular: true,
    irregularNote: 'This phrase follows dar: doy papaya, di papaya, daré papaya.',
  },
  caminar_mucho: {
    ...
    irregular: true,
    irregularNote: 'Keep mucho in the phrase: camino mucho, caminé mucho, caminaré mucho.',
  },
  chinear: {
  ...
  pelar_el_diente: {
    ...
    irregular: true,
    irregularNote: 'Keep el diente in the phrase: pelo el diente, pelé el diente, pelaré el diente.',
  },
  estar_alerta: {
    ...
    irregular: true,
    irregularNote: 'This phrase follows estar: estoy alerta, estuve alerta, estaré alerta.',
  },
  rumbear_valluno: {
    presente: generateArConjugation('rumbe'),
    preterito: { yo: 'rumbeé', vos: 'rumbeaste', el: 'rumbeó', nosotros: 'rumbeamos', ustedes: 'rumbearon' },
  ...
  golear_mucho: {
    ...
    irregular: true,
    irregularNote: 'Keep mucho in the phrase: goleo mucho, goleé mucho, golearé mucho.',
  },
  ...
  contar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo cuento, él cuenta, ustedes cuentan. Vos stays regular.',
  },
  creer: {
    ...
    irregular: true,
    irregularNote: 'Past él/ustedes add y: creyó/creyeron. Yo, vos, and nosotros keep í.',
  },
  dejar: {
  ...
  probar: {
    ...
    irregular: true,
    irregularNote: 'Present to watch: yo pruebo, él prueba, ustedes prueban. Vos stays regular.',
  },
  'reír': {
    ...
    irregular: true,
    irregularNote: 'Keep the í sound in present and past: río, reís, reímos.',
  },
  sacar: {
