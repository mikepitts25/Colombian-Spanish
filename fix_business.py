...
business_translations = {
    ...
    "La directora va a aprobar el presupuesto.": "The director is going to approve the budget.",
    ...
    "El plazo para entregar es el lunes.": "The deadline to deliver is Monday.",
    ...
    "Pedí un aumento de salario este año.": "I asked for a salary raise this year.",
    ...
    "Pedí permiso para ir al médico.": "I asked for leave to go to the doctor.",
    "Estoy en incapacidad por una semana.": "I'm on sick leave for a week.",
    ...
    "Con gusto le ayudo con eso.": "Happy to help you with that.",
...
fix_file('business.ts', business_translations)
